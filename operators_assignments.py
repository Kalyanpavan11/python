...
print({1, 2, 3, 5} - {3, 4, 7, 8}) #{1, 2, 5}
print({1, 2, 3, 5} + {3, 4, 7, 8}) #error

# What will be the output of following programs
print('Hi ' + 'Anil') #Hi Anil
...
print(2 not in [3, 4, 5, 2, 9]) #false
print([1, 2, 5, (1, 2)] in ['hi', 3, 4, 5, 2, 9, [1, 2, 5, (1, 2)]]) #true
